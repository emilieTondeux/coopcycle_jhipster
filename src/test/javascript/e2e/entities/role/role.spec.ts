...
describe('Role e2e test', () => {
  ...
  it('should load Roles', async () => {
    ...
    expect(await roleComponentsPage.getTitle()).to.eq('coopcycleJhipsterApp.role.home.title');
  ...
  it('should load create Role page', async () => {
    ...
    expect(await roleUpdatePage.getPageTitle()).to.eq('coopcycleJhipsterApp.role.home.createOrEditLabel');
  ...
  it('should create and save Roles', async () => {
    ...
    await promise.all([roleUpdatePage.setRoleInput('role')]);

    expect(await roleUpdatePage.getRoleInput()).to.eq('role', 'Expected Role value to be equals to role');
  ...
  it('should delete last Role', async () => {
    ...
    expect(await roleDeleteDialog.getDialogTitle()).to.eq('coopcycleJhipsterApp.role.delete.question');

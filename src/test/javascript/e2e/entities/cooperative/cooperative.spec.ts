...
describe('Cooperative e2e test', () => {
  ...
  it('should load Cooperatives', async () => {
    ...
    expect(await cooperativeComponentsPage.getTitle()).to.eq('coopcycleJhipsterApp.cooperative.home.title');
    await browser.wait(
  ...
  it('should load create Cooperative page', async () => {
    ...
    expect(await cooperativeUpdatePage.getPageTitle()).to.eq('coopcycleJhipsterApp.cooperative.home.createOrEditLabel');
  ...
  it('should delete last Cooperative', async () => {
    ...
    expect(await cooperativeDeleteDialog.getDialogTitle()).to.eq('coopcycleJhipsterApp.cooperative.delete.question');
